...
import com.rsons.application.connecting_thoughts.ChatActivityAndClasses.MyAdapter;
...
public class EditPublishedStory extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        actionBar.setTitle(getString(R.string.EDIT_PUBLISHED_STORY));
        ...
        mDraftAdapter =new DraftStoryAdapter(Story_list,EditPublishedStory.this,true);
    ...
    private void loadStories() {
        ...
        Log.e("skdfjsf","Calling edit published story ");
        ...
        Query getData=storyRef.whereEqualTo("story_status","publish").orderBy("story_timestamp_published", Query.Direction.DESCENDING);
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()){
                    for (DocumentSnapshot document : task.getResult()) {
                        Log.e("fdfggsd","Doc id is "+document.getId());
                        if (!StoryIdList.contains(document.getId())){
                            ...
                            Temp_Story_list.add(new Simple_Story(document.getId(),document.getString("story_title"),document.getString("cover_image"),
                                    document.get("story_timestamp_published")));
        ...
        getData.get().addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                Log.e("dkfsjls","this is error message "+e.getMessage());
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId()==R.id.new_story){
            Intent LaunchWriteStory=new Intent(EditPublishedStory.this, WriteStoryActivity.class);
