...
public class ImageDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int currentPosition=ReturnCurrentPosition(""+pos);
        Log.e("fjskjsd","current image position "+currentPosition);
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                //Log.e("fjksfjsfkls","this is current page scrolling "+position+" previous position "+PreviousPosition);
    ...
    private int ReturnCurrentPosition(String pos) {

        for (int i=0;i<data.size();i++){
            Log.e("fjskjsd","inside array "+data.get(i).name+" actual index "+pos);
            if (data.get(i).name.equals(pos)){
                return i;
            }
        }
